...
@Service
public class WorldCountryService implements ICircuitBreaker {
	
	static Logger logger = Logger.getLogger(WorldCountryService.class);
	@Autowired
    RestTemplate restTemplate;
	
	public WorldCountryService(RestTemplate rest) {
	...
	public String getCountryDetails(String country) {
		...
		String response = restTemplate.exchange("http://worldcountry/getCountry?country={country}",
